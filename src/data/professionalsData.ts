...
export interface SampleProfile {
  ...
  avatarBg: string       // tailwind-safe pastel hex
  avatarColor: string
}

export const SAMPLE_PROFILES: SampleProfile[] = [
  {
    id: 'p1', name: 'Gipsz Jakab', category: 'Gipszkartonos', location: 'Budapest és Pest megye',
    intro: 'Álmennyezetek, válaszfalak és előtétfalak kivitelezése lakásfelújításoknál és családi házaknál.',
    badge: 'Demo profil', badgeColor: 'gray', rating: 4.8, reviews: 23,
    specialties: ['gipszkarton válaszfal', 'álmennyezet', 'rejtett LED előkészítés'],
    reference: 'Demo referencia: 72 m²-es lakás teljes gipszkartonozása.', availability: 'Demo profil',
    avatarInitials: 'GJ', avatarBg: '#E8F5EC', avatarColor: '#2D5C3A',
  },
  {
    id: 'p2', name: 'Példa Villany Kft.', category: 'Villanyszerelő', location: 'Budapest, Érd, Budaörs',
    intro: 'Lakásfelújítások és családi házak elektromos hálózatának korszerűsítése.',
    badge: 'Referencia ellenőrzött', badgeColor: 'green', rating: 4.9, reviews: 31,
    specialties: ['teljes hálózatcsere', 'villanyóra szabványosítás', 'FI-relé', 'okosotthon előkészítés'],
    reference: 'Demo referencia: 100 m²-es családi ház elektromos szerelése.', availability: 'Demo profil',
    avatarInitials: 'PV', avatarBg: '#FEF9EE', avatarColor: '#92400E',
  },
  {
    id: 'p3', name: 'TetőPont Ács Team', category: 'Ács', location: 'Fejér megye, Veszprém megye',
    intro: 'Tetőszerkezetek építése, javítása és fedés előkészítése.',
    badge: 'Validáció alatt', badgeColor: 'yellow', rating: 4.7, reviews: 18,
    specialties: ['tetőszerkezet', 'faanyagvédelem', 'tetőfelújítás'],
    reference: 'Demo referencia: nyeregtetős családi ház tetőszerkezete.', availability: 'Demo profil',
    avatarInitials: 'TP', avatarBg: '#E8F0F7', avatarColor: '#2A4A6B',
  },
  {
    id: 'p4', name: 'Bádog Profi Demo', category: 'Bádogos', location: 'Budapest és agglomeráció',
    intro: 'Ereszcsatorna, szegélyek, lemezelések és vízelvezetési csomópontok kivitelezése.',
    badge: 'Demo profil', badgeColor: 'gray', rating: 4.6, reviews: 14,
    specialties: ['ereszcsatorna', 'szegélylemez', 'kéményszegély'],
    reference: 'Demo referencia: tetőfelújítás bádogos munkái.', availability: 'Demo profil',
    avatarInitials: 'BP', avatarBg: '#F5F0E8', avatarColor: '#5C4A2A',
  },
  {
    id: 'p5', name: 'BurkolatMester Demo', category: 'Burkoló', location: 'Budapest',
    intro: 'Fürdőszobák, konyhák, nappalik és teraszok burkolási munkái.',
    badge: 'Előszűrt partner', badgeColor: 'blue', rating: 4.8, reviews: 27,
    specialties: ['fürdőszoba burkolás', 'vízszigetelés előkészítés', 'nagylapos burkolat'],
    reference: 'Demo referencia: komplett fürdőszoba burkolás.', availability: 'Demo profil',
    avatarInitials: 'BM', avatarBg: '#EFF6FF', avatarColor: '#1D4ED8',
  },
  {
    id: 'p6', name: 'Színvonal Festő Team', category: 'Festő', location: 'Pest megye',
    intro: 'Tisztasági festés, glettelés, javítás és teljes lakásfestés.',
    badge: 'Demo profil', badgeColor: 'gray', rating: 4.5, reviews: 19,
    specialties: ['glettelés', 'tisztasági festés', 'penészgátló festés'],
    reference: 'Demo referencia: 120 m²-es családi ház beltéri festése.', availability: 'Demo profil',
    avatarInitials: 'SF', avatarBg: '#F0EEE8', avatarColor: '#4A4A38',
  },
  {
    id: 'p7', name: 'OtthonKontroll Kft.', category: 'Műszaki ellenőr', location: 'Országos / online egyeztetés',
    intro: 'Fázisellenőrzés, kivitelezői egyeztetés és hibamegelőzés építkezőknek.',
    badge: 'Validációs koncepció', badgeColor: 'blue', rating: 4.9, reviews: 12,
    specialties: ['műszaki ellenőrzés', 'fázisátvétel', 'hibajegyzék'],
    reference: 'Demo referencia: családi ház szerkezetkész állapotának ellenőrzése.', availability: 'Demo profil',
    avatarInitials: 'OK', avatarBg: '#E8F5EC', avatarColor: '#2D5C3A',
  },
  {
    id: 'p8', name: 'Víz-Gépész Partner', category: 'Víz-gáz-fűtésszerelő', location: 'Budapest, Szentendre, Dunakeszi',
    intro: 'Vízkiállások, fűtési rendszer, fürdőszobai gépészet és felújítási munkák.',
    badge: 'Referencia ellenőrzött', badgeColor: 'green', rating: 4.7, reviews: 22,
    specialties: ['fürdőszoba gépészet', 'radiátoros rendszer', 'padlófűtés előkészítés'],
    reference: 'Demo referencia: fürdőszoba teljes gépészeti átalakítása.', availability: 'Demo profil',
    avatarInitials: 'VG', avatarBg: '#EEF0F5', avatarColor: '#3A4A60',
  },
  {
    id: 'p9', name: 'Térkő Expressz Demo', category: 'Térkövező', location: 'Pest megye, Fejér megye',
    intro: 'Bejárók, járdák, teraszok és kerti térburkolatok kivitelezése.',
    badge: 'Demo profil', badgeColor: 'gray', rating: 4.6, reviews: 16,
    specialties: ['térkövezés', 'szegélyezés', 'alapréteg előkészítés'],
    reference: 'Demo referencia: 85 m² kocsibeálló térkövezése.', availability: 'Demo profil',
    avatarInitials: 'TE', avatarBg: '#F5EEE8', avatarColor: '#604A38',
  },
  {
    id: 'p10', name: 'ÉpítésFinansz Partner', category: 'Finanszírozó', location: 'Országos',
    intro: 'Építési és felújítási finanszírozási lehetőségek előszűrése.',
    badge: 'Partner előnézet', badgeColor: 'blue', rating: 4.8, reviews: 9,
    specialties: ['építési hitel', 'felújítási hitel', 'támogatási lehetőségek'],
    reference: 'Demo referencia: finanszírozási előszűrés családi ház építéshez.', availability: 'Demo profil',
    avatarInitials: 'ÉP', avatarBg: '#E8F5EC', avatarColor: '#2D5C3A',
  },
]
