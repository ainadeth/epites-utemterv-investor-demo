  ...
  return (
    <div className="animate-fade-up">
      ...
      <div className="page-top pb-8 text-center max-w-2xl mx-auto px-4">
        <span
          className="inline-flex items-center gap-1.5 text-[11px] font-semibold tracking-widest uppercase rounded-full px-3.5 py-1.5 mb-5 border"
        ...
        <div
          className="inline-flex items-center gap-2 rounded-xl px-4 py-2 text-xs font-medium border"
          style={{ background: 'var(--surface)', borderColor: 'var(--border)', color: 'var(--tx-secondary)' }}
        >
          📂 Projekttípus:{' '}
          <span className="font-semibold ml-1" style={{ color: '#4A7C59' }}>
            {projectLabel}
          </span>
        </div>
      </div>
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {cards.map((card) => (
            <MaterialCardItem key={card.id} card={card} onCTA={() => setActiveCardId(card.id)} />
          ))}
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 mb-4">
          {PARTNER_CARDS.map((c) => (
            ...
            >
              ...
              <p className="text-xs font-semibold mb-1" style={{ color: 'var(--tx-primary)' }}>
                {c.title}
              </p>
...
function MaterialCardItem({ card, onCTA }: { card: MaterialCard; onCTA: () => void }) {
  ...
  return (
    <div className="card p-5 flex flex-col gap-3 transition-all hover:scale-[1.005]">
      <div className="flex items-start justify-between gap-3">
        ...
        <span
          className="shrink-0 text-[10px] font-semibold rounded-full px-2.5 py-1 border whitespace-nowrap"
      ...
      <div
        className="rounded-xl px-3 py-2.5 border-l-2 text-[11px] leading-relaxed"
      ...
      <div>
        ...
        <div className="flex items-center justify-between px-6 py-5 border-b shrink-0" style={{ borderColor: 'var(--border)' }}>
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-xl flex items-center justify-center text-lg" style={{ background: '#E8F5EC' }}>
              {card.icon}
            </div>
            <div>
              <p className="text-sm font-semibold" style={{ color: 'var(--tx-primary)' }}>
          ...
          {submitted ? (
            <div className="flex flex-col items-center text-center py-6 gap-4">
              <div
                ...
                style={{ background: '#E8F5EC', borderColor: '#A8C5B0' }}
              >
                ✅
              </div>
              <div>
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                boxShadow: '0 3px 10px rgba(74,124,89,.25)',
              }}
            >
              Értesítést kérek
            </button>
  ...
  return (
    <Modal isOpen={true} onClose={onClose} size="md">
      <div>
        ...
        <div className="flex items-center justify-between px-6 py-5 border-b shrink-0" style={{ borderColor: 'var(--border)' }}>
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-xl flex items-center justify-center text-lg" style={{ background: 'var(--sage-light)' }}>
              🔍
            </div>
            <div>
              <p className="text-sm font-semibold" style={{ color: 'var(--tx-primary)' }}>
                Beszerzési forrás előnézet
              </p>
              <p className="text-xs" style={{ color: 'var(--tx-muted)' }}>
                {sourceLabel}
              </p>
        ...
        {!submitted && (
          ...
          >
            ...
            <button
              ...
              style={{
                background: 'linear-gradient(135deg,#3D6B4A,#4A7C59)',
                boxShadow: '0 3px 10px rgba(74,124,89,.22)',
              }}
            >
              Értesítést kérek
            </button>
